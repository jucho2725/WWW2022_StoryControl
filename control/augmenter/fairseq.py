...
class Fairseq(LanguageModels):
    ...
    def predict(self, text, top_k=None, top_p=None, sampling = True, temperature=None,):
        translated_text = self.from_model.translate(text, verbose=False, sampling=sampling, temperature=temperature,
                                                    top_k=None, top_p=None)
        back_translated_text = self.to_model.translate(translated_text, verbose=False, sampling=sampling, temperature=temperature,
                                                    top_k=None, top_p=None)
